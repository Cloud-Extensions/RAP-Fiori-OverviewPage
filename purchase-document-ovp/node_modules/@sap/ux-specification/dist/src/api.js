...
function generateSchema(generateParameters) {
    ...
    if (generateParameters[page_1.FioriElementsVersion.v2]) {
        ...
        if (v2Params[schemaAccess_1.SchemaType.ListReport]) {
            const { genericSchema, entitySet, annotations, manifest, fragments } = v2Params[schemaAccess_1.SchemaType.ListReport];
            schema = generate_1.generateListReportInterfaceV2(genericSchema, entitySet, annotations, manifest, fragments);
        }
        else if (v2Params[schemaAccess_1.SchemaType.ObjectPage]) {
            const { genericSchema, entitySet, annotations, manifest, fragments } = v2Params[schemaAccess_1.SchemaType.ObjectPage];
            schema = generate_1.generateObjectPageInterfaceV2(genericSchema, entitySet, annotations, manifest, fragments);
        }
            ...
            const { genericSchema, entitySet, annotations, manifest, fragments } = v2Params[schemaAccess_1.SchemaType.AnalyticalListPage];
            schema = generate_1.generateAnalyticalListPageInterfaceV2(genericSchema, entitySet, annotations, manifest, fragments);
        }
    }
        ...
        if (v4Params[schemaAccess_1.SchemaType.ListReport]) {
            const { genericSchema, entitySet, annotations } = v4Params[schemaAccess_1.SchemaType.ListReport];
            schema = generate_2.generateListReportInterfaceV4(genericSchema, entitySet, annotations);
        }
            ...
            const { genericSchema, entitySet, annotations } = v4Params[schemaAccess_1.SchemaType.AnalyticalListPage];
