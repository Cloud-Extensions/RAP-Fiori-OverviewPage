...
function generateId(page) {
    return common_2.generatePageId(common_2.getPageTypeV2(page.component.name), page.entitySet, page.navigationProperty);
}
...
class V2AppProvider extends appProvider_1.AppProvider {
    constructor(manifest, changes, schemas, fragments) {
        ...
        // Call base
        super(manifest, schemas, generateId(v2Pages[Object.keys(v2Pages)[0]]), getPagesAndConfigs(v2Pages, changes, manifest, schemas, fragments), common_1.FioriElementsVersion.v2, appSettings);
    }
}
