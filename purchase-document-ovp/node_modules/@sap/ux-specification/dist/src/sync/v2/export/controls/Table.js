...
function importCreateParameters(manifestSection) {
    const configPart = {
        createWithParameterDialog: JSON.parse(JSON.stringify(manifestSection))
    };
    return configPart;
}
exports.importCreateParameters = importCreateParameters;
function exportCreateParameters(manifestSection, configPart, key) {
    manifestSection['createWithParameterDialog'] = JSON.parse(JSON.stringify(configPart[key]['createWithParameterDialog']));
}
...
], CommonTableSettings.prototype, "toolbarActions", void 0);
__decorate([
    decoration_1.syncRule({
        flex: {
    ...
    decoration_1.syncRule({
        manifest: {
            ...
            export: (manifestSection, configObject) => {
                manifestSection['quickVariantSelectionX'] = configObject['quickVariantSelectionX'];
                const quickVariantSelectionX = configObject['quickVariantSelectionX'];
