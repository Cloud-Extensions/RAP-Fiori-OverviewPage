...
function exportFilterSettings(manifestSection, configPart, key) {
    if (!manifestSection['filterSettings']) {
        manifestSection['filterSettings'] = {};
    }
    FilterBar_1.exportDateSettings(manifestSection['filterSettings'], configPart['filterSettings'], 'dateSettings');
}
