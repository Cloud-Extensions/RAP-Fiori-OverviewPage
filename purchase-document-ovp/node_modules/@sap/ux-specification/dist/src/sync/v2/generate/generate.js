...
function generateObjectPageInterfaceV2(genericSchema, entitySet, annotations, manifest, fragments, logger) {
    ...
    return objectPage_1.generateObjectPageSchemaV2(genericSchema, entitySet, service, manifest, fragments);
}
...
function generateListReportInterfaceV2(genericSchema, entityType, annotations, manifest, fragments, logger) {
    const service = utils_1.parseAndMergeAndConvert(annotations, logger);
    return listReport_1.generateListReportSchemaV2(genericSchema, entityType, service.entityTypes, manifest, fragments);
}
...
function generateAnalyticalListPageInterfaceV2(genericSchema, entityType, annotations, manifest, fragments, logger) {
    const service = utils_1.parseAndMergeAndConvert(annotations, logger);
    return analyticalListReport_1.generateAnalyticalListReportSchemaV2(genericSchema, entityType, service.entityTypes, manifest, fragments);
}
