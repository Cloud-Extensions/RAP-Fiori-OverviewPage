 ...
 * @returns the app specific JSON schema
 */
export declare function generateListReportInterfaceV2(genericSchema: object, entityType: string, annotations: FileData[], manifest: object, fragments?: FileData[], logger?: ExtensionLogger): object;
/**
 ...
 * @param manifest - manifest.json of the app
 */
export declare function generateAnalyticalListPageInterfaceV2(genericSchema: object, entityType: string, annotations: FileData[], manifest: object, fragments?: FileData[], logger?: ExtensionLogger): object;
