 ...
 */
export declare function exportToFragment(exportResults: ExportResults, path: string, config: TableCustomColumns, appId: string, viewTemplateType: ViewTemplateType, logger?: ExtensionLogger): void;
/**
