 ...
 */
function getPagesAndConfigs(manifest, schemas) {
    const pages = {};
    ...
    for (const id in routing.targets) {
        ...
        const schemaId = common_1.generatePageId(page.pageType, page.entitySet, page.navigationProperty, target['viewId']);
        if (!schemaId) {
            continue;
        }
        pages[id] = page;
            ...
            page.config =
                page.pageType === common_2.PageTypeV4.ListReport
                    ...
                    : page.pageType === common_2.PageTypeV4.AnalyticalListPage
                        ? analyticalListPage_1.createAnalyticalListPageConfig(manifest, schemas[jsonSchema])
...
class V4AppProvider extends appProvider_1.AppProvider {
    constructor(manifest, schemas) {
        ...
        super(manifest, schemas, getHome(manifest['sap.ui5'].routing), getPagesAndConfigs(manifest, schemas), common_2.FioriElementsVersion.v4, Object.assign(Object.assign({}, getSettings(manifest['sap.ui5'].routing)), appSettings));
