 ...
 */
export declare function createFlexChange(configObject: object, breadcrumbs: string[], syncRule: SyncRule, ui5Version: string, baseId: string, ids: string[], title: string, key: string): ChangeDefinitionInCreation;
export {};
