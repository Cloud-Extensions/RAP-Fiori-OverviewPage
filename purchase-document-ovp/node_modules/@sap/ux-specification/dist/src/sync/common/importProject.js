 ...
 */
function generateAppSchemasV2(genericSchemas, uiEntityTypes, oDataServiceAVT, manifest, templateType, fragments) {
    ...
    if (templateType === utils_1.TemplateType.ListReportObjectPageV2 && uiEntityTypes) {
        ...
        for (const page in allPages) {
            ...
            appSchemas[schemaFile.filename] = generate_1.generateListReportSchemaV2(genericSchemas[genericSchemaFile.filename], entityTypeName, entityTypes, manifest, fragments);
        }
        /*--- Object Pages ----*/
        ...
        for (const page in allPages) {
            ...
            appSchemas[schemaFile.filename] = generate_1.generateAnalyticalListReportSchemaV2(genericSchemas[genericSchemaFile.filename], entityTypeName, entityTypes, manifest, fragments);
        }
        /*--- Object Pages ----*/
        generateObjectPageSchemasV2(genericSchemas, manifest, oDataServiceAVT, appSchemas);
    }
    ...
    if (uiEntityTypes) {
        if (templateType === utils_1.TemplateType.ListReportObjectPageV4) {
            ...
            for (const page in pages) {
                ...
                const schemaFile = utils_1.getSchemaFilePath(common_1.SchemaType.ListReport, entityTypeName);
                const genericSchemaFile = utils_1.getSchemaFilePath(common_1.SchemaType.ListReport);
                appSchemas[schemaFile.filename] = generate_2.generateListReportSchemaV4(genericSchemas[genericSchemaFile.filename], entityTypeName, oDataServiceAVT);
            }
            /*--- Object Pages ----*/
 ...
 */
async function generateAppSchemas(uiEntityTypes, fioriElementsVersion, oDataServiceAVT, manifest, templateType, fragments) {
    ...
    if (fioriElementsVersion === common_1.FioriElementsVersion.v4) {
        ...
        return generateAppSchemasV2(genericSchemas, uiEntityTypes, oDataServiceAVT, manifest, templateType, fragments);
    }
}
/**
