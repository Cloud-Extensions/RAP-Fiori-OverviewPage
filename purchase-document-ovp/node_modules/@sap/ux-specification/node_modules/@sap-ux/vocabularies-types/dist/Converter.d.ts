...
export declare type ComplexType = Omit<ParserComplexType, "properties" | "navigationProperties"> & {
    properties: Property[];
...
export declare type EntityType = Omit<ParserEntityType, "entityProperties" | "navigationProperties" | "keys"> & {
    _type: "EntityType";
...
export declare type EntitySet = Omit<ParserEntitySet, "entityType"> & {
    _type: "EntitySet";
