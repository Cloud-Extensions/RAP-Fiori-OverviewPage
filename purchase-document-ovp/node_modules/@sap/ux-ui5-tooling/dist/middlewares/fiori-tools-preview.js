...
var _seq = __webpack_require__(112);
...
var _parseMap = __webpack_require__(186);
...
var _parseSeq = __webpack_require__(188);

var _Seq = __webpack_require__(40);
...
var _Pair = __webpack_require__(27);
...
var _sourceUtils = __webpack_require__(179);
...
var _toJSON = __webpack_require__(48);
...
var _BlankLine = __webpack_require__(71);

var _CollectionItem = __webpack_require__(181);
...
var _Scalar = __webpack_require__(14);
...
var _warnings = __webpack_require__(185);
...
var _tags = __webpack_require__(268);

var _string = __webpack_require__(74);

var _Alias = __webpack_require__(73);
...
var _PlainValue = __webpack_require__(182);

var _errors = __webpack_require__(6);

var _Map = __webpack_require__(41);

var _Merge = __webpack_require__(183);

var _Pair = __webpack_require__(27);

var _parseUtils = __webpack_require__(187);
...
var _pairs = __webpack_require__(113);
...
module.exports = __webpack_require__(254).YAML
...
var _parse = __webpack_require__(255);

var _Document = __webpack_require__(264);

var _errors = __webpack_require__(6);

var _schema = __webpack_require__(184);
...
var _ParseContext = __webpack_require__(258);
...
var _Collection = __webpack_require__(180);

var _Comment = __webpack_require__(109);

var _Directive = __webpack_require__(257);
...
var _BlockValue = __webpack_require__(260);

var _Collection = __webpack_require__(180);

var _CollectionItem = __webpack_require__(181);

var _FlowCollection = __webpack_require__(261);

var _Node = __webpack_require__(13);

var _PlainValue = __webpack_require__(182);

var _QuoteDouble = __webpack_require__(262);

var _QuoteSingle = __webpack_require__(263);
...
var _Anchors = __webpack_require__(265);

var _constants = __webpack_require__(3);

var _errors = __webpack_require__(6);

var _listTagNames = __webpack_require__(266);
...
var _failsafe = __webpack_require__(110);

var _json = __webpack_require__(270);

var _yaml = __webpack_require__(271);

var _map = __webpack_require__(111);

var _seq = __webpack_require__(112);

var _binary = __webpack_require__(189);

var _omap = __webpack_require__(190);

var _pairs = __webpack_require__(113);

var _set = __webpack_require__(191);

var _timestamp = __webpack_require__(192);
...
var _foldFlowLines = __webpack_require__(267);
...
Object.defineProperty(exports, "__esModule", { value: true });
const i18next_1 = __importDefault(__webpack_require__(33));
const i18n_json_1 = __importDefault(__webpack_require__(108));
...
Object.defineProperty(exports, "__esModule", { value: true });
const express_1 = __importDefault(__webpack_require__(117));
const utils_1 = __webpack_require__(428);
const i18next_1 = __importDefault(__webpack_require__(33));
const i18n_1 = __webpack_require__(70);
const path_1 = __webpack_require__(1);
const utils_2 = __webpack_require__(771);
module.exports = async ({ options }) => {
    ...
    if (await utils_1.isODataV4(manifestPath)) {
        // generates the preview.html on the fly
        const router = express_1.default.Router();
        router.use('/preview.html', (req, res, next) => {
            utils_2.servePreviewHtml(req, res, next, options.configuration);
        });
        // adds the WorkspaceConnector to the existing index.html
        router.use('/index.html', (req, res, next) => {
            utils_2.addWorkspaceConnector(req, res, next, options.configuration);
        });
...
Object.defineProperty(exports, "__esModule", { value: true });
const ejs_1 = __webpack_require__(772);
const fs_1 = __webpack_require__(2);
const path_1 = __webpack_require__(1);
const yaml_1 = __importDefault(__webpack_require__(230));
const ux_app_templates_1 = __webpack_require__(775);
 ...
 */
const generatePreviewHtml = (template, templateData, urlParams) => {
...
/**
 * Returns the preview.html, when requested
 *
 * @param req The http request object
 * @param res The http response object
 * @param next The next function, used to forward the request to the next avaialble handler
 * @param config The configuration of the fiori-tools-preview middleware
 */
exports.servePreviewHtml = async (req, res, next, config) => {
    try {
        const urlParams = parseUrlParams(req.query);
        const template = await fs_1.promises.readFile(path_1.join(ux_app_templates_1.templatesDirPath, "variants-management" /* VariantsManagement */, "preview.html" /* PreviewHtml */), { encoding: 'utf8' });
        const templateData = Object.assign(defaultOptions, config);
        if (urlParams['fiori-tools-rta-mode']) {
            const html = generatePreviewHtml(template, templateData, urlParams);
            if (res['_livereload']) {
                res.write(html);
                res.end();
            }
 ...
 */
exports.serveWorkspaceConnector = async (req, res, next) => {
    try {
        const workspaceConnector = await fs_1.promises.readFile(path_1.join(ux_app_templates_1.templatesDirPath, "variants-management" /* VariantsManagement */, "WorkspaceConnector.js" /* WorkspaceConnector */), { encoding: 'utf8' });
        res.status(200)
...
/**
 * Returns the name of html file, which is used to preview the application, from the runtime arguments
 *
 * @param args runtime arguments
 */
const getHtmlFile = (args) => {
    let html = 'index.html';
    const index = args.indexOf('--open') !== -1 ? args.indexOf('--open') : args.indexOf('-o');
    if (index !== -1) {
        const arg = args[index + 1];
        if (arg.indexOf('?') !== -1) {
            html = arg.split('?')[0].replace(/["']/g, '');
        }
...
/**
 * Injects the WorkspaceConnector configuration into the html file, which is used to preview the application
 *
 * @param req The http request object
 * @param res The http response object
 * @param next The next function, used to forward the request to the next avaialble handler
 * @param config The configuration of the fiori-tools-preview middleware
 */
exports.addWorkspaceConnector = async (req, res, next, config) => {
    var _a, _b, _c;
    try {
        const projectRoot = process.cwd();
        if (hasChanges(projectRoot)) {
            const args = process.argv;
            const htmlFileName = getHtmlFile(args);
            const yamlFileName = getYamlFile(args);
            const ui5YamlPath = path_1.join(projectRoot, yamlFileName);
            let resourcesFolder = 'webapp';
            if (fs_1.existsSync(ui5YamlPath)) {
                const ui5Yaml = yaml_1.default.parseDocument(await fs_1.promises.readFile(ui5YamlPath, { encoding: 'utf8' })).toJSON();
                if ((_c = (_b = (_a = ui5Yaml.resources) === null || _a === void 0 ? void 0 : _a.configuration) === null || _b === void 0 ? void 0 : _b.paths) === null || _c === void 0 ? void 0 : _c.webapp) {
                    resourcesFolder = ui5Yaml.resources.configuration.paths.webapp;
                }
            }
            const htmlFilePath = path_1.join(projectRoot, resourcesFolder, htmlFileName);
            if (fs_1.existsSync(htmlFilePath)) {
                let html = await fs_1.promises.readFile(htmlFilePath, { encoding: 'utf8' });
                const connectorConfig = 'data-sap-ui-flexibilityServices=\'[{"applyConnector": "' +
                    config.component.replace(/\\./g, '/') +
                    '/WorkspaceConnector", "writeConnector": "' +
                    config.component.replace(/\\./g, '/') +
                    '/WorkspaceConnector", "custom": true}]\'';
                const bootstrap = html.match(/(<script\s*[^>]*src="\/{0,1}resources\/sap-ui-core\.js"[^>]*)>/);
                if (bootstrap) {
...
/** @type {string} */
var _VERSION_STRING = __webpack_require__(774).version;
...
exports.templatesDirPath = path_1.join(__dirname, '../templates');
...
Object.defineProperty(exports, "__esModule", { value: true });
// TO DO Sync with App Gen PROJECT_TYPE
exports.PROJECT_TYPE = {
    ...
    AnalyticalListPage: 'ANALYTICAL_LIST_PAGE' // Non-version specific ALP
};
// TO DO Sync with App Gen DatasourceType
var DatasourceType;
(function (DatasourceType) {
    DatasourceType["FILE"] = "File";
    DatasourceType["URL"] = "OData Url";
    DatasourceType["CAP"] = "Local Cap";
    DatasourceType["SAP_SYSTEM"] = "SAP System";
    DatasourceType["API_HUB"] = "SAP API Hub";
    DatasourceType["NONE"] = "None";
})(DatasourceType = exports.DatasourceType || (exports.DatasourceType = {}));
// TO DO Sync with App Gen DatasourceType
exports.SapUiLibs = {
    [exports.PROJECT_TYPE.ListReportObjectPageV2]: 'sap.m, sap.ushell, sap.ui.core, sap.f, sap.ui.comp, sap.ui.table, sap.suite.ui.generic.template, sap.ui.generic.app',
    [exports.PROJECT_TYPE.AnalyticalListPageV2]: 'sap.m, sap.ushell, sap.ui.core, sap.f, sap.ui.comp, sap.ui.table, sap.suite.ui.generic.template, sap.ui.generic.app',
    [exports.PROJECT_TYPE.ListReportObjectPageV4]: 'sap.m, sap.ushell, sap.fe.templates',
    [exports.PROJECT_TYPE.OverviewPageV2]: 'sap.m, sap.f, sap.ushell, sap.ui.core, sap.ui.layout, sap.ui.generic.app, sap.ui.comp, sap.suite.ui.generic.template, sap.ovp, sap.ui.rta',
    [exports.PROJECT_TYPE.WorklistV2]: 'sap.m, sap.ushell, sap.ui.core, sap.f, sap.ui.comp, sap.ui.table, sap.suite.ui.generic.template, sap.ui.generic.app, sap.collaboration',
